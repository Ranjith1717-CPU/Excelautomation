@echo off
title Excel Automation — Validator Module
color 0B

echo.
echo  ============================================================
echo    EXCEL AUTOMATION TOOLKIT  — VALIDATOR MODULE
echo    Mandatory Fields, Email, Phone, Range, Date, PII Detection
echo  ============================================================
echo.
...
echo.
echo  Launching Validator module...
echo  ============================================================
echo.
