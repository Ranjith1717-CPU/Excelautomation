@echo off
title Excel Automation — Sales Module
color 0B

echo.
echo  ============================================================
echo    EXCEL AUTOMATION TOOLKIT  — SALES MODULE
echo    Commission, RFM, Quota, Pipeline, Territory, ABC, Discount
echo  ============================================================
echo.
