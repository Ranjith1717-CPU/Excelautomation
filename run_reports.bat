@echo off
title Excel Automation — Generate Reports
color 0B

echo.
echo  ============================================================
echo    EXCEL AUTOMATION TOOLKIT  — GENERATE REPORTS
echo    Summary, Data Profile, KPI, Top-N, Frequency, Monthly
echo  ============================================================
echo.
