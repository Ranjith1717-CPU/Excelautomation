@echo off
title Excel Automation — Consolidate Files
color 0B

echo.
echo  ============================================================
echo    EXCEL AUTOMATION TOOLKIT  — CONSOLIDATE FILES
echo    Stack, Join, Merge, Extract from Multiple Excel Files
echo  ============================================================
echo.
...
echo.
echo  Launching Consolidate module...
echo  ============================================================
echo.
